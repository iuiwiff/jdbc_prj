...
public class AdminProfMgtMdfyDesign extends JFrame {
	...
	public AdminProfMgtMdfyDesign() {
		...
		ImageIcon bannerImage2 = new ImageIcon(imagePath + "mdfybanner.png");
		...
		jlEssential.setBounds(688, 445, 120, 15);
