...
public class StudentLoginDesign extends JFrame {
    ...
    StudentLoginDesign(SelectLoginEvent sle) {
        ...
        StudentLoginEvent stle = new StudentLoginEvent(this);
        
        addWindowListener(stle);
        loginButton.addActionListener(stle);
        jtfId.addActionListener(stle);
        jpfPass.addActionListener(stle);
